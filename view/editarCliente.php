                        ...
                        <form class="form-group mt-3 col mx-auto" id="formCliente" action="../controllers/controllerCliente.php" method="post">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input required class="form-control" type="text" id="nome" name="nome" value="<?php echo $nome; ?>"><br />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input required class="form-control" type="text" id="endereco" name="endereco" value="<?php echo $endereco; ?>" /><br />
                                </div>
                            </div>
                            ...
                            <div class=" row">
                                <div class="col">
                                    ...
                                    <input required class="form-control" type="number" id="telefone" name="telefone" value="<?php echo $telefone; ?>"><br />
                                </div>

                                <div class="col">
                                    <label class="form-label" for="cpf">CPF:</label><br />
                                    <input required class="form-control" type="number" id="cpf" name="cpf" value="<?php echo $cpf; ?>"><br />
                                </div>

                                <div class="col">
                                    <label class="form-label" for="dataNascimento">Data Nascimento:</label><br />
                                    <input required class="form-control" type="text" id="dataNascimento" name="dataNascimento" value="<?php echo $dataNascimento; ?>"><br />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input required class="form-control" type="email" id="email" name="email" value="<?php echo $email; ?>" /><br />
                                </div>

                                <div class="col">
                                    <label class="form-label" for="senha">Senha:</label><br />
                                    <input required class="form-control" type="password" id="senha" name="senha" value="<?php echo $senha; ?>" /><br />
                                </div>
                            </div>
